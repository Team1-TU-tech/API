...
from src.final_login.routers import like  # tickets 라우터를 포함한 모듈
...
# CORS 설정
#origins = [f"http://www.ticketmoa.org", "http://54.180.135.217"]
#origins = [f"http://{API_APP_HOST}:3000", "http://{API_APP_HOST}:8000", "http://localhost:3000"]
#origins = [f"http://{API_APP_HOST}:3000",  "http://localhost:3000"]
